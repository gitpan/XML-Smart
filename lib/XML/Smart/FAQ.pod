...
=head2 Do I need to install XML::Parser to can use XML::Smart?
...
=head2 What is the best version of XML::Smart to install?
...
=head2 Where can I learn about XML?

http://www.xml.com

=head2 How to apply a DTD to a XML::Smart object tree?
...
=head2 When I generate the XML data new lines (\n) are added to the content!
...
=head2 Your question is not here?
